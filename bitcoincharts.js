...
function getOHLC({timeframe = 1, resolution = '30-min', transpose = false} = {})
{
	return new Promise((resolve, reject) => {
...
function getLast(OLHCArray, ticker)
{
	return OLHCArray[OLHCArray.length - 1];
}
	
	
function _getRawBitcoinOHLC({
		timeframe = 1,
		customTime,
		resolution = '30-min'		
	} = {})
...
function _addToOLHCArray(element, obj)
{
	if (obj==null)
	{
		obj = {};
